...
Workflowy obejmujące:

- procesy oparte na formularzach z walidacją i logiką warunkową,
- integracje z Google Workspace (Sheets, Calendar, Gmail, Drive),
- Slack i Notion do powiadomień wewnętrznych i prowadzenia rejestrów,
- Airtable jako lekką bazę danych,
- API oparte na webhookach, wdrożone na własnym serwerze VPS,
- odczyt i wyciąganie danych z przychodzących dokumentów PDF,
- klasyfikację i generowanie treści z wykorzystaniem AI przy obsłudze poczty,
- chatboty oparte na AI.

Część z tych projektów to małe, jednorazowe buildy. Kilka z nich — obieg faktur i asystent mailowy oparty na AI — rozrosło się przez kilka sesji pracy w coś bliższego realnemu narzędziu wewnętrznemu.

## Nagrania

Kilka gotowych już produktów nagranych jako prezentacja — nie proces budowy, tylko oprowadzenie po ukończonym workflowie: co robi, jak jest zbudowany i dlaczego działa tak, a nie inaczej. Te projekty są bliskie stanu, w którym można je przekazać klientowi albo wstawić na stronę internetową.

- AI Research Agent,
- Jin8zo AI Chatbot,
- AI Customer Support,
- AI Email Assistant — klasyfikuje przychodzącą pocztę i przygotowuje szkice odpowiedzi do zatwierdzenia przed wysyłką.
